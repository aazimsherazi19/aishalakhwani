...
const Achievements = () => {
  return (
    <section className="py-18 bg-gradient-to-r from-primary to-teal-500 pt-10 pb-10  text-white dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 duration-200">
