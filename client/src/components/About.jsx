...
import dr from '../assets/dr.webp'; // Replace with your image path
import vr from '../assets/vr.webp'; // Replace with your image path
...
<section className="flex flex-col items-center py-16 bg-blue-500 text-white text-center relative animation-fade-in dark:bg-gray-700 dark:text-white duration-200">
  <h1 className="text-5xl font-bold mb-4 animate-slide-in-up">About Us</h1>
...
{/* Our Mission Section */}
<section className="py-16 bg-white text-blue-600 animation-slide-in-left relative dark:bg-gray-900 dark:text-white duration-200">
  <div className="container mx-auto px-4 flex items-center justify-between">
    <div className="w-full md:w-2/3">
      <h2 className="text-4xl font-semibold text-center mb-4">Our Mission</h2>
    ...
    <div className="w-full md:w-1/3 flex justify-end">
      ...
      {/* Our Team Section */}
      <section className="py-16 bg-blue-100 dark:bg-gray-800 dark:text-white duration-200">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-semibold text-center text-blue-600 mb-8 animate-slide-in-right">Meet Our Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate-slide-in-up">
              ...
              <p className="text-center text-lg text-blue-600">CEO & Founder</p>
            </div>
            {/* Team Member 2 */}
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate-slide-in-up">
              <img src="" alt="Team Member" className="w-32 h-32 mx-auto mb-4 rounded-full" />
              <h3 className="text-2xl font-semibold text-center mb-2">Jane Smith</h3>
              <p className="text-center text-lg text-blue-600">Lead Developer</p>
            </div>
            {/* Team Member 3 */}
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate-slide-in-up">
              <img src="" alt="Team Member" className="w-32 h-32 mx-auto mb-4 rounded-full" />
              <h3 className="text-2xl font-semibold text-center mb-2">Alex Johnson</h3>
              <p className="text-center text-lg text-blue-600">UX/UI Designer</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Values Section */}
      <section className="py-16 bg-white text-blue-600 dark:bg-gray-900 dark:text-white duration-200">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-semibold text-center mb-6 animate-slide-in-left">Our Core Values</h2>
          <ul className="space-y-4 text-lg max-w-3xl mx-auto">
            <li className="flex items-center justify-center">
              <span className="text-xl mr-4 text-blue-600">&#10003;</span> Innovation is at the heart of everything we do.
            </li>
            <li className="flex items-center justify-center">
              <span className="text-xl mr-4 text-blue-600">&#10003;</span> Customer satisfaction drives our actions.
            </li>
            <li className="flex items-center justify-center">
              <span className="text-xl mr-4 text-blue-600">&#10003;</span> We foster a culture of collaboration and creativity.
            </li>
          </ul>
        </div>
      </section>
      ...
      {/* Contact CTA Section */}
      <section className="py-16 bg-blue-500 text-white text-center dark:bg-gray-800 dark:text-white duration-200  ">
        ...
        <button className="bg-white text-blue-600 py-2 px-6 rounded-lg hover:bg-blue-700 hover:text-white transition-colors duration-300">
          Contact Us
        </button>
      </section>
    </div>
